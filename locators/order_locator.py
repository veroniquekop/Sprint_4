...
class OrderLocators:
    button_order_up_locator = (By.XPATH, "//*[contains(@class, 'Button_Button__ra12g')][1]")  # Кнопка 'Заказать' (сверху)
    button_order_down_locator = (By.XPATH, "//*[contains(@class, 'Button_Middle__1CSJM')]") # Кнопка 'Заказать' (снизу)
    accept_cookies = (By.XPATH, "//*[contains(@class, 'App_CookieButton__3cvqF')]") # Кнопка 'Принять куки'
    ...
    button_next_locator = (By.XPATH, "//*[contains(@class, 'Button_Middle__1CSJM')]") #Кнопка Далее
    ...
    checkbox_colour_black_locator = (By.XPATH, "//*[contains(@class, 'Checkbox_Input__14A2w')][1]")  # Чекбокс 'Выбрать цвет' (чёрный)
    ...
    confirm_order_button_locator = (By.XPATH, "//*[contains(@class, 'Button_Button__ra12g Button_Middle__1CSJM')][2]")  # Подтвердить заказ
    popup_locator = (By.XPATH, "//*[contains(@class, 'Order_Modal__YZ-d3')]")  # попап "Статус заказа"
    ...
    popup_status_locator = (By.XPATH, "//*[contains(@class, 'Order_Modal__YZ-d3')][4]")  # попап "статус"
